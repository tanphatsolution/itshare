...
<div class="col-sm-12 post create-post">
    ...
    @endif
    {{ Form::open(['route' => 'faq.questions.store', 'id' => 'create-post']) }}
    <input type="hidden" name="encrypted_id" id="encrypted_id" value="0" />
    <input type="hidden" id="type_post" value="question" />
    <div class="col-md-12">
...
@section('script')
    ...
    {{ HTML::script(version('js_min/post_create.min.js')) }}
@stop
