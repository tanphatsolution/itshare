<title>{{ isset($title) ? htmlspecialchars($title) : \Config::get('app.app_name') }}</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
<meta name="_token" content="{{ csrf_token() }}">
<meta name="description" content="{{ isset($description) ? htmlspecialchars($description) : trans('app.app_description') }}">
...
<meta property="og:title" content="{{ isset($title) ? htmlspecialchars($title) : Config::get('app.app_name') }}">
<meta property="og:description" content="{{ isset($description) ? htmlspecialchars($description) : trans('app.app_description') }}">
...
<link rel="canonical" href="{{ isset($url) ? $url : Config::get('app.url') }}" />
<!-- meta tag for twitter -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:url" content="{{ isset($url) ? $url : Config::get('app.url') }}">
<meta name="twitter:title" content="{{ isset($title) ? htmlspecialchars($title) : Config::get('app.app_name') }}">
<meta name="twitter:description" content="{{ isset($description) ? htmlspecialchars($description) : trans('app.app_description') }}">
...
<!-- Design -->
{{ HTML::style(version('css_min/layout_head.min.css')) }}
@yield('css')
