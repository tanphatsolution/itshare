<div class="group-post-element group-content-element col-lg-12">
    <div class="group-thumbnail">
        ...
        <div class="group-caption col-lg-9 col-md-9 col-sm-9 col-xs-9">
            <div class="group-item-info">
                <a class="group-name-title break-word" href="{{ url_to_post($post) }}">
                    {{{ str_limit($post->title, $limit = 110, $end = '...') }}}
                </a>
