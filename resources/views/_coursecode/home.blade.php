...
<html lang="en">
    <head>
        ...
        {{ HTML::style('training/img/logo.png', ['rel' => 'shortcut icon']) }}

        <!-- Bootstrap CSS, Font-awesome -->
        {{ HTML::style('training/bootstrap/css/bootstrap.min.css') }}
        {{ HTML::style('training/font-awesome/css/font-awesome.min.css') }}
        <!-- Customers -->
        {{ HTML::style('training/customers/styles.css') }}
        {{ HTML::style('training/customers/styles-responsive.css') }}
        {{ HTML::style('training/customers/css/home.css') }}
    </head>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/" title="Trang chủ">
                            {{ HTML::image('training/img/logo.png', 'logo', ['width' => 75, 'height' => 75]) }}
                        </a>
                    </div>
        ...
        <!-- #banner -->
        <div id="banner">
            <div class="jumbotron" style="background: url('/training/img/banner.jpg'); background-size: cover;">
        ...
        <div id="content">
                ...
                <div class="row">
                        ...
                        <div class="course">
                            <div class="course-img">
                                <a href="javascript:;" title="">
                                    {{ HTML::image('training/img/html-course.png', 'HTML-COURSE', ['class' => 'img-responsive']) }}
                                </a>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="course">
                            <div class="course-img">
                                <a href="javascript:;" title="">
                                    {{ HTML::image('training/img/css-course.png', 'CSS-COURSE', ['class' => 'img-responsive']) }}
                                </a>
                            </div>
                            <div class="course-info">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="course">
                            <div class="course-img">
                                <a href="javascript:;" title="">
                                    {{ HTML::image('training/img/js-course.png', 'js-course', ['class' => 'img-responsive']) }}
                                </a>
                            </div>
                            <div class="course-info">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="course">
                            <div class="course-img">
                                <a href="javascript:;" title="">
                                    {{ HTML::image('training/img/jquery-course.jpg', 'JQUERY-COURSE', ['class' => 'img-responsive']) }}
                                </a>
                            </div>
                            <div class="course-info">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="course">
                            <div class="course-img">
                                <a href="javascript:;" title="">
                                    {{ HTML::image('training/img/php-course.png', 'php-course', ['class' => 'img-responsive']) }}
                                </a>
                            </div>
                            <div class="course-info">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="image col-md-6">
                            {{ HTML::image('training/img/tpage-slide01.jpg', 'Tpage-slide001', ['class' => 'img-responsive']) }}
                        </div>
                    </div> <!-- /.row -->
                </div> <!-- /.container -->
            </div> <!-- /.category -->
            ...
            <div class="category">
                <div class="container">
                    <div class="row">
                        <div class="image col-md-6">
                            {{ HTML::image('training/img/tpage-slide02.jpg', 'Tpage-slide002', ['class' => 'img-responsive']) }}
                        </div>
                        <div class="about col-md-6">
                            <h3 class="title text-uppercase">
                                <a href="#">Python</a>
            ...
            <div class="category bg-white">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="image col-md-6">
                            {{ HTML::image('training/img/tpage-slide03.jpg', 'Tpage-slide03', ['class' => 'img-responsive']) }}
                        </div>
                    </div> <!-- /.row -->
                </div> <!-- /.container -->
            </div> <!-- /.category -->
        ...
        {{ HTML::script('training/customers/js/jquery.js') }}
        {{ HTML::script('training/bootstrap/js/bootstrap.min.js') }}
        {{ HTML::script('training/customers/js/main.js') }}
    </body>
</html>
